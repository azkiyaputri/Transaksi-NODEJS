...
// GET: /detail_pelanggaran_siswa/:id_pelanggarannya_siswa --> end-point untuk menampilkan detail pelanggaran
app.get("/:id_pelanggarannya_siswa", (req,res) => {
...
app.post("/", (req,res) => {
    let data = {
        id_pelanggarannya_siswa: req.body.id_pelanggarannya_siswa,
...
app.delete("/:id_pelanggarannya_siswa/:id_pelanggaran", (req, res) => {
    let data = [
        req.params.id_pelanggarannya_siswa,
        req.params.id_pelanggaran
    ]

    // create sql query delete detail_pelanggaran
    let sql = "delete from detail_pelanggaran_siswa where id_pelanggarannya_siswa = ? and id_pelanggaran = ?"
